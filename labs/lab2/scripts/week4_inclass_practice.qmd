...
pa_counties <- st_read(here("labs/lab2/scripts/data/Pennsylvania_County_Boundaries.shp"))
districts <- st_read(here("labs/lab2/scripts/data/districts.geojson"))
hospitals <- st_read(here("labs/lab2/scripts/data/hospitals.geojson"))
